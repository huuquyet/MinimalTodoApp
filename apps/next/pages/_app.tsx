...
const APP_TITLE = 'Minimal Todo App'
const APP_DESCRIPTION = 'Minimal Todo App built with Tamagui, Expo, Next.js & Solito monorepo'
const APP_URL = 'https://minimaltodoapp.vercel.app/'
